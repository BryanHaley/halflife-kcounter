...
BuildCmds= \
	copy $(TargetDir)\hl.dll \Sierra\Half-Life\killcount\dlls \
	copy $(TargetDir)\hl.map \Sierra\Half-Life\killcount\dlls \
	

"\Sierra\Half-Life\killcount\dlls\hl.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"\Sierra\Half-Life\killcount\dlls\hl.map" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
# End Custom Build
